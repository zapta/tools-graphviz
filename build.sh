...
#DARWIN_URL="https://gitlab.com/api/v4/projects/4207231/packages/generic/graphviz-releases/12.1.2/Darwin_22.6.0_Graphviz-12.1.2-Darwin.zip"
...
SRC_DIR="https://gitlab.com/api/v4/projects/4207231/packages/generic/graphviz-releases/12.1.2"

if [ "${ARCH}" == "darwin" ]; then
   SRC_FILE="Darwin_22.6.0_Graphviz-12.1.2-Darwin.zip"
   EXTRACT="unzip"
   INSTALL="$WORK_DIR/scripts/install_darwin.sh"
elif [ "${ARCH}" == "darwin_arm64" ]; then
   SRC_FILE="Darwin_22.6.0_graphviz-12.1.2-arm64.tar.gz"
   EXTRACT="tar -xvzf"
   INSTALL="$WORK_DIR/scripts/install_darwin_arm64.sh"
else
   print_help_exit 
   echo
...
SRC_URL=$SRC_DIR/$SRC_FILE

echo "SRC_URL = $SRC_URL"

echo "SRC_FILE = $SRC_FILE"

#URL=$(get_arch_src_url)
...
# -----------------------------------------------------------
PACKAGE_NAME=tools-graphviz-$ARCH-$VERSION.tar.gz
echo ""
